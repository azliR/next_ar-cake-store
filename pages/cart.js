  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>GoBakery ECommerce - Keranjang</title>
          <meta name="description" content={`GoBakery ECommerce - Keranjang`} />
          <meta
            property="og:title"
            content="GoBakery ECommerce - Keranjang"
            key="title"
          />
        </Head>
        <div
        ...
        >
          <div className="pt-10 pb-8">
            <h1 className="text-5xl font-light">Keranjang</h1>
          </div>
